<nav class="navbar navbar-default">
  <div class="container-fluid back">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo e(route('product.index')); ?>">PastriesLand</a>
    ...
    <ul class="nav navbar-nav navbar-right">
        <?php if(Auth::guest()): ?>
                            ...
                            <li><a href="<?php echo e(url('/register')); ?>"><i class="fa fa-user-plus" aria-hidden="true"></i> Registrarse</a></li>
                        <?php else: ?>
                            <li><a href="<?php echo e(route('product.shoppingcart')); ?>">
                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> Carrito  <span class="badge">  <?php echo e(Session::has('cart') ? Session::get('cart')->totalqty :''); ?></span>
                                </a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('/user/profile')); ?>">Perfil</a> </li>
