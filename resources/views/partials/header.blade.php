<nav class="navbar navbar-default">
  <div class="container-fluid back">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ route('product.index')}}">PastriesLand</a>
        ...
        @if (Auth::guest())
                        ...
                        @else
                            <li><a href="{{ route('product.shoppingcart') }}">
                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> Carrito  <span class="badge">  {{ Session::has('cart') ? Session::get('cart')->totalqty :'' }}</span>
                                </a></li>
                            <li class="dropdown">
